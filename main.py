...
class face_recognization_system:
    ...
    def create_gui(self):
        ...
        window.state('zoomed')
        image_path = "D:/SCD LAB PROJECT VERSION 1.5/SCD LAB PROJECT VERSION 1.5/uni.png"
    ...
    def create_login_window(self):
        ...
        image_path = r"D:\SCD LAB PROJECT VERSION 1.5\SCD LAB PROJECT VERSION 1.5\uni.png"
        img = Image.open(image_path)
        bg_image = ImageTk.PhotoImage(img)
...
def show_loading_screen():
    ...
    image_path = "D:/SCD LAB PROJECT VERSION 1.5/SCD LAB PROJECT VERSION 1.5/vector2.png"
    img = Image.open(image_path)
